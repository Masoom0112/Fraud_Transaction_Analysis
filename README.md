# 2nd-Project
This is a synthetic financial transactions dataset containing 6.36 million transactions simulating mobile money transfers over 743 time steps (roughly 30 days).
